...
const Filter = () => {
  return (
        <div id='filter' className='grid grid-cols-4 mt-2 mb-4 gap-2'>
            ...
            <div className='overflow-x-scroll md:overflow-hidden flex gap-2 col-span-3 md:col-start-1 md:row-start-1 md:col-span-4'>
