     ...
     <div className='p-[5px] bg-white rounded-lg'>
      {/* <div className='overflow-hidden rounded-lg shadow-lg bg-white'> */}
        <div className='rounded-md overflow-hidden relative'>
            ...
            />
            <p className='font-semibold text-md line-clamp-1 text-ellipsis'>{data.nama}</p>
            <p className='text-xs text-secondary-1 line-clamp-1 text-ellipsis'>{data.kategori}</p>
            <p className='text-sm font-semibold text-primary'>${data.price}<span className='text-xs text-secondary-1'>/pcs</span></p>
